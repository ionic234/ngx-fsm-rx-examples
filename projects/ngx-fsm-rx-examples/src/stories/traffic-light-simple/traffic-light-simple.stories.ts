...
import { TrafficLightSimpleComponent } from './components/traffic-light-simple/traffic-light-simple.component';

const meta: Meta<TrafficLightSimpleComponent> = {
    title: 'Examples/1. Traffic Light Simple',
    component: TrafficLightSimpleComponent,
    decorators: [
        moduleMetadata({
...
export default meta;
type Story = StoryObj<TrafficLightSimpleComponent>;
