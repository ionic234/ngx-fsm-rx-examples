...
<article>
  ...
  <p>These composite states describe both the visual state of the <code>TrafficLightRequestCrossingComponent</code> (<b>"stop"</b>) and the instruction sent to the <code>CrossingControlBoxComponent</code>(<b>"startWalking"</b> / <b>"finishWalking"</b>) as follows:</p>
  <ul>
    <li>Entering the <b>"stop_startWalking"</b> state signals the <code>CrossingControlBoxComponent</code> to enter its <b>"startWalking"</b> state.</li>
    <li>Entering the <b>"stop_finishWalking"</b> state signals the <code>CrossingControlBoxComponent</code> to enter its <b>"finishWalking"</b> state.</li>
    <li>Leaving the <b>"stop_finishWalking"</b> state signals the <code>CrossingControlBoxComponent</code> to enter its <b>"doNotWalk"</b> state.</li>
  </ul>
  ...
  <p>The <code>TrafficLightRequestCrossingAlternateComponent</code> defines condition transition logic using transition cancelling via the <code>prepareToStop</code> states <code>onLeave</code> callback function.
